        ...
        if (adminCheck(interaction)) {
            if(interaction.options.getString("symbol") != undefined) {
                if ((interaction.options.getString("symbol").length == 1) && (isSymbol.test(interaction.options.getString("symbol")))) {
                    prefixFile[serverID] = {"prefix": interaction.options.getString("symbol")};
                    ...
                    return embedCustom(interaction, 'Current Prefix:', '#008000', `Current Prefix is ${interaction.options.getString("symbol")}`, { text: `Requested by ${interaction.user.username}`, iconURL: null }, null, [], null,null);
                } else {
