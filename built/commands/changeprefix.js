...
//#region Helpers
var _a = require('../helpers/embedMessages.js'), errorNoAdmin = _a.errorNoAdmin, warnCustom = _a.warnCustom, embedCustom = _a.embedCustom, errorCustom = _a.errorCustom;
                        ...
                        if (adminCheck(message)) {
                            if (args[0] != undefined) {
                                if (args[0].length == 1 && isSymbol.test(args[0])) {
                                    ...
                                    serverConfig.save();
                                    return [2 /*return*/, embedCustom(message, 'Current Prefix:', '#008000', "Current Prefix is ".concat(args[0]), {
                                            text: "Requested by ".concat(message.author.tag),
                                            iconURL: null,
                                        }, null, [], null, null)];
                                }
                                else {
                                    return [2 /*return*/, warnCustom(message, 'Bot Prefix Must be ONE of the following: ```~!$%^&*()_+-={}[]|:";\'<>?,./```', module.name)];
                                }
                            }
                            else {
                                return [2 /*return*/, warnCustom(message, 'You must define a bot prefix.', module.name)];
                            }
                        }
                        else {
                            return [2 /*return*/, errorNoAdmin(message, module.name)];
                        }
                        return [2 /*return*/];
                }
            });
