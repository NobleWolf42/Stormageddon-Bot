...
module.exports = {
    ...
    execute: function (message, args, client, distube) {
        return __awaiter(this, void 0, void 0, function () {
            var dbCall, serverConfig, voiceChannel, queue;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!queue) {
                            ...
                            return [2 /*return*/, warnCustom(message, 'Music is already paused.', module.name)];
                        }
                        else {
                            queue.pause();
                            embedCustom(message, 'Pause', '#0000FF', "Music Paused.", { text: "Requested by ".concat(message.author.tag), iconURL: null }, null, [], null, null);
                        }
                        return [2 /*return*/];
                }
            });
