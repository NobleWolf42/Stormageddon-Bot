...
module.exports = {
    ...
    execute: function (message, args, client, distube) {
        return __awaiter(this, void 0, void 0, function () {
            var dbCall, serverConfig, voiceChannel, queue, song, removeMe;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!queue) {
                            ...
                            return [2 /*return*/, warnCustom(message, "Number must be between 1 and ".concat(queue.songs.length), module.name)];
                        }
                            ...
                            removeMe = queue.songs.splice(args[0] - 1, 1)[0];
                            if (!removeMe) {
                                return [2 /*return*/, (errorCustom(message, 'Failed to remove the track from the queue.', module.name), client)];
                            }
                            return [2 /*return*/, embedCustom(message, 'Removed', '#0000FF', "Removed [`".concat(removeMe.name, "`](").concat(removeMe.url, ") from the queue."), { text: "Requested by ".concat(message.author.tag), iconURL: null }, null, [], null, null)];
                        }
                        return [2 /*return*/];
                }
            });
