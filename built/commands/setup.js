...
//#endregion
//#region Internals
var setup = require('../internal/settingsFunctions.js').setup;
//#endregion
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!serverConfig[message.guild.id].setupNeeded) return [3 /*break*/, 4];
                        if (!message.member.permissions.has(PermissionFlagsBits.Administrator)) return [3 /*break*/, 2];
                        return [4 /*yield*/, setup(message)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
