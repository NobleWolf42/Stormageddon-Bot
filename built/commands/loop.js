...
module.exports = {
    ...
    execute: function (message, args, client, distube) {
        return __awaiter(this, void 0, void 0, function () {
            var dbCall, serverConfig, voiceChannel, queue, loopMode, mods;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!queue) {
                            ...
                            return [2 /*return*/, warnCustom(message, "You must use one of the following options: ".concat(mods.join(', ')), module.name)];
                        }
                        else {
                            if (loopMode == 'song') {
                                queue.setRepeatMode(1);
                                return [2 /*return*/, embedCustom(message, "Loop On", '#0E4CB0', 'Music set to loop song.', {
                                ...
                                return [2 /*return*/, embedCustom(message, "Loop On", '#0E4CB0', 'Music set to loop queue.', {
                                        text: "Requested by ".concat(message.author.tag),
                                        iconURL: null,
                                    }, null, [], null, null)];
                            }
                                ...
                                return [2 /*return*/, embedCustom(message, "Loop Off", '#0E4CB0', 'Music has returned to normal playback.', {
                                        text: "Requested by ".concat(message.author.tag),
                                        iconURL: null,
                                    }, null, [], null, null)];
                            }
