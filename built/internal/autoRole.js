...
function generateEmbedFields(serverID) {
    return serverConfig[serverID].autoRole.roles.map(function (r, e) {
        return {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    emojiKey = data.emoji.id
                        ? "".concat(data.emoji.name, ":").concat(data.emoji.id)
                        : data.emoji.name;
                        ...
                        if (message.embeds.length >= 1) {
                            ...
                            _loop_1 = function (name_1, value) {
                                if (member.id !== client.user.id) {
                                    ...
                                    if (name_1 === reaction.emoji.name ||
                                        name_1 === reaction.emoji.toString()) {
