...
try {
    ...
    client.on(Events.ClientReady, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield slashCommandHandling(client, distube, extraColl, youtube);
        console.log('Starting Message Logging Listener');
        yield logMessageUpdate(client);
