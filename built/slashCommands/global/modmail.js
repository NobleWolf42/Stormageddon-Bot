...
var _b = require('../../helpers/embedSlashMessages.js'), errorCustom = _b.errorCustom, warnCustom = _b.warnCustom, warnDisabled = _b.warnDisabled;
//#endregion
...
module.exports = {
    ...
    execute: function (client, interaction, distube) {
        return __awaiter(this, void 0, void 0, function () {
            var serverConfig, serverID, servername, content, modList, _a, _b, _c, _i, mod, embMsg;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, embedCustom(interaction, 'Mod Mail Sent.', '#0B6E29', "**Message:** `".concat(content, "` \n**Sent To:** `The Mods at ").concat(servername, "`"), {
                            text: "Requested by ".concat(interaction.user.username),
                            iconURL: null,
                        }, null, [], null, null)];
                    case 5: return [2 /*return*/, warnDisabled(interaction, 'modMail', module.name, client)];
                    case 6: return [3 /*break*/, 8];
                    case 7:
                        if (serverConfig[serverID] == undefined) {
                            return [2 /*return*/, errorCustom(interaction, "The `!setup` command has not been run on `".concat(servername, "` yet."), module.name, client)];
                        }
                        else {
                            return [2 /*return*/, warnCustom(interaction, 'The server you specified does not have this bot, or you failed to specify a server.', module.name, client)];
                        }
                        _d.label = 8;
