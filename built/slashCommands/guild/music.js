            ...
            switch (interaction.options.getSubcommand()) {
                ...
                case 'remove': {
                    ...
                    if (song == 1) {
                        ...
                        queue.skip().then(() => {
                            embedCustom(interaction, 'Removed', '#0000FF', `Removed [\`${oldSong.name}\`](${oldSong.url}) from the queue.`, {
                                text: `Requested by ${interaction.user.username}`,
                                iconURL: null,
                            }, null, [], null, null);
                        });
                        ...
                        embedCustom(interaction, 'Removed', '#0000FF', `Removed [\`${removeMe.name}\`](${removeMe.url}) from the queue.`, {
                            text: `Requested by ${interaction.user.username}`,
                            iconURL: null,
                        }, null, [], null, null);
                    }
