...
module.exports = {
    ...
    execute(client, interaction, distube) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var serverConfig = (yield MongooseServerConfig.findById(interaction.guildId).exec()).toObject();
            ...
            switch (interaction.options.getSubcommand()) {
                ...
                case 'lyrics':
                    ...
                    slicedLyrics.forEach((m, index) => __awaiter(this, void 0, void 0, function* () {
                        embedCustom(interaction, `${song.fullTitle} - ${index + 1} of ${slicedLyrics.length}:`, '#0E4CB0', m, {
                            text: `Requested by ${interaction.user.username}`,
                            iconURL: null,
                        }, null, [], null, null);
                    }));
                ...
                case 'remove':
                    ...
                    if (!queue) {
                        ...
                        queue.skip().then(() => {
                            embedCustom(interaction, 'Removed', '#0000FF', `Removed [\`${son.name}\`](${song.url}) from the queue.`, {
                                text: `Requested by ${interaction.user.username}`,
                                iconURL: null,
                            }, null, [], null, null);
                        });
                        ...
                        return embedCustom(interaction, 'Removed', '#0000FF', `Removed [\`${removeMe.name}\`](${removeMe.url}) from the queue.`, {
                            text: `Requested by ${interaction.user.username}`,
                            iconURL: null,
                        }, null, [], null, null);
                    }
                ...
                case 'skipto':
                    ...
                    if (!queue) {
                        ...
                        queue.skip().then((s) => {
                            embedCustom(interaction, 'Skipped', '#0000FF', `Skipped to [\`${s.name}\`](${s.url}).`, {
                                text: `Requested by ${interaction.user.username}`,
                                iconURL: null,
                            }, null, [], null, null);
                        });
                ...
                case 'volume':
                    ...
                    if (!queue) {
                        ...
                        embedCustom(interaction, 'Volume', '#0000FF', `Volume is currently ${queue.volume}%.`, {
                            text: `Requested by ${interaction.user.username}`,
                            iconURL: null,
                        }, null, [], null, null);
                    }
