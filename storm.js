...
client.on("message", message => {
    ...
    if (command == (prefix + 'register')) {
        message.reply('Click on this link to register: https://discordapp.com/api/oauth2/authorize?client_id=648179533115293697&redirect_uri=http%3A%2F%2Fnoblewolf42.com%3A3000%2F&response_type=code&scope=identify%20email%20connections');
    }
    //#endregion
