...
async function errorNoAdmin(interaction, commandName, client) {
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#FF0000')
        .setDescription(
            'You do not have permission to use this command. This command requires *BOT ADMIN* access to use!'
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
...
async function errorNoMod(interaction, commandName, client) {
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#FF0000')
        .setDescription(
            'You do not have permission to use this command. This command requires *BOT MOD* access to use!'
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
...
async function errorNoDJ(interaction, commandName, client) {
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#FF0000')
        .setDescription(
            'You do not have permission to use this command. This command requires *DJ* access to use!'
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
...
async function errorNoServerAdmin(interaction, commandName, client) {
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#FF0000')
        .setDescription(
            'You do not have permission to use this command. This command requires *SERVER ADMIN* access to use!'
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
 ...
 * @param {Client} client - A Discord.js Client Object
 */
async function warnWrongChannel(
    interaction,
    correctChannel,
    commandName,
    client
    ...
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#F8AA2A')
        .setDescription(
            `That was not the correct channel for that command. The correct channel for this command is #${correctChannel}`
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
...
async function warnDisabled(interaction, feature, commandName, client) {
    const embMsg = new EmbedBuilder()
        ...
        .setColor('#F8AA2A')
        .setDescription(
            `This feature is currently disabled. To enable it, please run the !set ${feature}. NOTE: This command is only available to a server admin.`
        )
        .setFooter({
            text: `Requested by ${interaction.user.username}`,
            iconURL: null,
