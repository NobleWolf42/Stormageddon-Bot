...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription(
            'Allows you to change the settings for your voice channel.'
        )
    ...
    execute(client, interaction, distube) {
        ...
        if (
            client.voiceGenerator.get(interaction.member.id) &&
            ...
            switch (interaction.options.getSubcommand()) {
                case 'name':
                    ...
                    if (newName.length > 22 || newName.length < 1) {
                        warnCustom(
                            interaction,
                            'Not a valid name length, Length must be between 1-22 characters long!',
                            module.name,
                            client
                        );
                    } else {
                ...
                default:
                    warnCustom(
                        interaction,
                        'Not a valid Join to Create command!',
                        module.name,
                        client
                    );
                    break;
            ...
            warnCustom(
                interaction,
                'You do not own a voice channel!',
                module.name,
                client
            );
        }
