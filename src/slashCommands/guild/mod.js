...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('mod')
        .setDescription(
            'Modify the modmail mod list. MUST HAVE SERVER ADMINISTRATOR STATUS.'
        )
    ...
    async execute(client, interaction, distube) {
        ...
        if (interaction.guild.id in serverConfig) {
            ...
            switch (interaction.options.getSubcommand()) {
                case 'add':
                    if (!userFound) {
                        ...
                        return warnCustom(
                            interaction,
                            `User ${user.tag} is already a Mod!`,
                            module.name,
                            client
                        );
                    }
                    ...
                    embedCustom(
                        ...
                        'Mod Added',
                        '#5D3FD3',
                        `Mod has been successfully added!`,
                        {
                ...
                case 'remove':
                    ...
                    embedCustom(
                        ...
                        'Mod Removed',
                        '#5D3FD3',
                        `Mod has been successfully removed!`,
                        {
                            text: `Requested by ${interaction.user.username}`,
                            iconURL: null,
                        },
            ...
            return errorCustom(
                interaction,
                'Server is not set up with the bot yet!',
                module.name,
                client
            );
        }
